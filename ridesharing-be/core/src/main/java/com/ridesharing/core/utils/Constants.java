...
public class Constants {
    ...
    public static final String RIDER_RIDE_APPROVED_TOPIC = "RiderRideApprovedTopic";
    public static final String RIDE_APPROVED_GROUP = "groupRideApproved";

    public static final String CLIENT_DISCONNECTS_TOPIC = "ClientDisconnectTopic";
    public static final String CLIENT_DISCONNECT_TOPIC_GROUP = "groupClientDisconnect";
